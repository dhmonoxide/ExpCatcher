...
/*class ScrollContentScene: CHScrollContentViewController {
    //@IBOutlet var scrollContentViewController:UIViewController!
}*/

@IBDesignable class RoundButton: RoundRectButton {
    @IBInspectable var corner:Double = 8.0 {
        didSet{
            super.corner_inspect = corner
        }
    }
    @IBInspectable var border:Double = 2.0 {
        didSet {
...
@IBDesignable class CircleImageView: CirclePhotoImageView {
    @IBInspectable var imageName:String = "" {
        didSet{
            super.imageName_inspect = imageName
        }
